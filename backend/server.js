...
const [basic, pro, business] = [
  "price_1NR9KHSI3ANpgzrSB37eQwwd",
  "price_1NR9LTSI3ANpgzrSHjUbURWg",
  "price_1NR9MHSI3ANpgzrSikIVEg6W",
];
...
app.post("/api/v1/create-subscription-checkout-session", async (req, res) => {
  ...
  else if (plan == 4999) planId = pro;
  else if (plan == 3999) planId = business;
