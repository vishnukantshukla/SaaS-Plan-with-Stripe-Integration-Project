...
const data = [
  {
    ...
    title: "Basic",
    price: "Free for 14 Days: Limited to 1 user",
  },
  {
    id: 2,
    ...
    title: "Per User, up to 5 users",
    price: "INR 4999 Per Year",
  },
  {
    id: 3,
    src: "https://images.unsplash.com/photo-1543269664-7eef42226a21?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    title: " Per User above 10 users",
    price: "INR 3999 Per Year",
  },
];
const Home = () => {
    ...
    <>
      <div className="flex flex-col items-center w-full mx-auto min-h-screen diagonal-background overflow-x-hidden">
        <div className="flex justify-between items-center w-full px-6 h-20 bg-[#00000012]">
          <div className="text-4xl font-bold text-white saas-custom">
